        ...
        <>
            <AppBar position="static">
                <Toolbar className="header-title">
                    ...
                    <Button onClick={() => history.push("/allPokemons")} className='backButton' variant="text">Go to all Pokemons</Button>
                </Toolbar>
            </AppBar>
            <Grid style={{width: "100%"}} container spacing={2} className="pokedexContainer">
...

                {
                    pokemonData.map((pokemon, i) => {
                        return <PokemonCard pokemon={pokemon} history={history} id={i} key={i}/>
                    })
                }
            </Grid>
